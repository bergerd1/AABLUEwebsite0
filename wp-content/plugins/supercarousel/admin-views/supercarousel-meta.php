...
<li class="w8">
<select name="super[source]" onchange="check_carousel_source(this);">
...
<option value="category:<?php echo $row->term_id; ?>"<?php echo ('content:'.$row->term_id==$source) ? ' selected="selected"' : ''; ?>>Category-<?php echo $row->name; ?></option>
